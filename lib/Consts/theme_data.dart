...
class Styles {
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData( //0xff424242
      bottomAppBarColor: isDarkTheme ? Colors.grey.shade700 :Colors.white,
      scaffoldBackgroundColor: isDarkTheme ? Colors.black :Colors.grey.shade300,
      primarySwatch: Colors.purple,
      primaryColor: isDarkTheme ? Colors.black : Colors.white,  //grey.shade300,

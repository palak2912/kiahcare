...
class RichTxt extends StatefulWidget {
  ...
  final Function()? textfunction, text1function, text2function, text3function;
  ...
  const RichTxt({
    ...
    this.useFiler3 = false, this.textfunction, this.text1function, this.text2function, this.text3function,
  }) : super(key: key);
...
//John*_-#![] → John
    ...
    return RichText(
      ...
      text: TextSpan(
        text: (finalText.isEmpty ? "Error" : finalText).toString(),
        style: TextStyle(  fontFamily: 'Ubuntu',
        ...
        children: <TextSpan>[
          TextSpan(
            text: (finalText1.isEmpty ? "Error" : finalText1).toString(),
            style: TextStyle(  fontFamily: 'Ubuntu',
            ...
            recognizer: TapGestureRecognizer()..onTap = () => widget.textfunction,
          ),
          TextSpan(
            ...
            recognizer: TapGestureRecognizer()..onTap = () => widget.text1function,
          ),
          TextSpan(
            ...
            recognizer: TapGestureRecognizer()..onTap = () => widget.text3function,
          ),
        ],
      ),
    );
